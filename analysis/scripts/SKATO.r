...
parser <- ArgumentParser(description="Script to run SKAT-O at gene-level")
#### Setup script doc and help messages
parser$add_argument('--cohort', type='character', dest="cohort", help='Cohort name eg. AMP_PD', required=TRUE)
parser$add_argument('--gene', type='character', dest="gene", help='Gene name eg. VPS11', required=TRUE)
