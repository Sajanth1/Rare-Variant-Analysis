...
# Filter for exonic variants (doesn't filter out if present with another consequence eg. "splice_polypyrimidine_tract_variant,intron_variant")
exon_df = VEP_df[
...
# func_df = VEP_df[
#     (VEP_df["Consequence"].str.contains(["5_prime_UTR_variant", "3_prime_UTR_variant"])) |
#     (VEP_df["IMPACT"].isin(["HIGH", "MODERATE"]))
# ]

# # Filter for inframe indels and missense variants
#inframe_df = VEP_df[VEP_df["IMPACT"] == "MODERATE"]

# Filter for nonsynonymous variants
nonsyn_df = VEP_df[VEP_df["Consequence"].str.contains("missense_variant")]
