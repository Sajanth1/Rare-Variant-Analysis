...
## Install VEP
apptainer pull --name vep.sif docker://ensemblorg/ensembl-vep:release_115.2
mkdir $HOME/vep_data
...
wget -nv -P "${PLUGINS_DIR}/CADD" https://kircherlab.bihealth.org/download/CADD/v1.7/GRCh38/whole_genome_SNVs.tsv.gz #CADD 1.7 
wget -nv -P "${PLUGINS_DIR}/CADD" https://kircherlab.bihealth.org/download/CADD/v1.7/GRCh38/whole_genome_SNVs.tsv.gz.tbi

CADD_INDEL=${PLUGINS_DIR}/CADD/gnomad.genomes.r4.0.indel.tsv.gz
wget -nv -P "${PLUGINS_DIR}/CADD" https://kircherlab.bihealth.org/download/CADD/v1.7/GRCh38/gnomad.genomes.r4.0.indel.tsv.gz #CADD 1.7 (indels)
wget -nv -P "${PLUGINS_DIR}/CADD" https://kircherlab.bihealth.org/download/CADD/v1.7/GRCh38/gnomad.genomes.r4.0.indel.tsv.gz.tbi
